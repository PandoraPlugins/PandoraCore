...
public abstract class Patch<T extends Packet<?>> extends PacketListener<T> implements Listener {
     ...
     */
    public Patch(String name, String description, boolean packets, boolean ignoreCancelled, Class<T> packetType, boolean isListener,
                 String... dependencies) {
